...
public class MyDbHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        String query="create table "+Table_products+"("+column_id+" INTEGER PRIMARY KEY AUTOINCREMENT, "+column_name+" TEXT, "+dob+" TEXT, "+cholestrol+" INTEGER, "+bp+" INTEGER, "+hypo+" INTEGER, "+glucose+" INTEGER );";
