...
public class Diabetes2Found extends ActionBarActivity {
    TextView tv;
    ScrollView sw;
    Button btn_diabtes;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv=(TextView) findViewById(R.id.tv_diabetes);
        sw= (ScrollView) this.findViewById(R.id.scrollView);
        tv.setText(Html.fromHtml(getString(R.string.ManageDiabetes)));
